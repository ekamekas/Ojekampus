...
public class Ojek extends User
{
     ...
     * 
     */
    public Ojek(int id, String uname, String nama, Lokasi posisiSekarang)
    {
    ...
    public Ojek(int id, String uname, String nama, String telefon, String noPlat, Lokasi posisiSekarang)
    {
        /* Konstruktor Ojek akan berperan sebagai inisiasi variabel dan instance Lokasi ketika Objek Ojek dibuat
         * Konstrukter akan melakukan inisiasi nilai variabel class dengan nilai parameter
         * Setiap parameter harus diisi dengan nilai paling tidak null atau 0
    ...
    public Ojek(int id, String uname, String nama, String telefon, String email, String noPlat, Lokasi posisiSekarang)
    {
        /* Konstruktor Ojek akan berperan sebagai inisiasi variabel dan instance Lokasi ketika Objek Ojek dibuat
         * Konstrukter akan melakukan inisiasi nilai variabel class dengan nilai parameter
         * Setiap parameter harus diisi dengan nilai paling tidak null atau 0
    ...
    public Ojek(int id, String uname, String nama, String telefon, String email, Date date, String noPlat, Lokasi posisiSekarang)
    {
        /* Konstruktor Ojek akan berperan sebagai inisiasi variabel dan instance Lokasi ketika Objek Ojek dibuat
         * Konstrukter akan melakukan inisiasi nilai variabel class dengan nilai parameter
         * Setiap parameter harus diisi dengan nilai paling tidak null atau 0
         ...
         */ 
        // this.id merupaakan nomor identitas yang merepresentasikan ojek
        super(id, uname, nama, telefon, email, date);
        //
        this.noPlat = noPlat;
